      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form id="loginform">
              <h1>Ganti Pasword Sebelum Login</h1>
              <div>
                <input type="text" class="form-control" placeholder="Username" required="" id="username" name="username" value="<?php echo $this->session->userdata('username') ?>" />
              ...
              <div>
                <input type="password" class="form-control" placeholder="Tulis Ulang Password" required="" id="repassword" name="repassword"/>
              </div>
              <div>
                ...
                success:function (response) {
                    if(response.success == true){
                      Swal.fire({
                        ...
                        "<?php delete_cookie('ci_session'); $this->session->sess_destroy(); ?>";
