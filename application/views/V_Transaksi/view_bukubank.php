  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Modal Tambah Mutasi Bank</h4>
      ...
      <div class="modal-body">
        <form id="post_" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Bank <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 ">
              <select id="NoRekening" name="NoRekening" class="form-control">
                <option value="">Pilih Bank..</option>
                <?php
                  $rs = $this->ModelsExecuteMaster->GetData('tbank')->result();

                  foreach ($rs as $key) {
                    echo "<option value = '".$key->NoRekening."'>".$key->NamaBank."(".$key->NoRekening.")</option>";
                  }
                ?>
              </select>
            </div>
        ...
        success: function (response) {
          ...
          for (var i = 0; i < response.data.length; i++) {
            ...
            if (response.data[i]["KodeAkun"] == "99") {
              ...
              arr = {
                NoRekening      : response.data[i]["NoRekening"],
                NamaBank        : response.data[i]["NamaBank"],
